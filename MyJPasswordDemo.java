...
class MyJPasswordField extends JPasswordField implements FocusListener {
...
public class MyJPasswordDemo {
    public static void main(String[] args) {
        ...
        MyJPasswordField f = new MyJPasswordField();
        frame.add(f);
        f.setBounds(400 - 230, 400 - 30, 460, 60);    
